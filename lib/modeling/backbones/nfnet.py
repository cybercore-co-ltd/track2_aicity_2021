...
if __name__=='__main__':
    ...
    model = dm_nfnet_f3(pretrained=True)
    # model = _create_normfreenet('dm_nfnet_f3', pretrained=pretrained, **kwargs)

    # import timm
    # model = timm.create_model('dm_nfnet_f3')
    # model = _gen_efficientnet('tf_efficientnet_l2_ns', channel_multiplier=4.3, depth_multiplier=5.3, pretrained=True)
    model(x)
    print()